#pragma checksum "D:\repos\piano-pizza\piano-pizza\Areas\PackerStaff\Views\Main\PackerProfile.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2861677397f4a804a6f9854b3f0e571547c9a775"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2861677397f4a804a6f9854b3f0e571547c9a775", @"/Areas/PackerStaff/Views/Main/PackerProfile.cshtml")]
...
#nullable disable
            ...
            BeginWriteAttribute("placeholder", " placeholder=\"", 4258, "\"", 4320, 1);
#nullable restore
#line 70 "D:\repos\piano-pizza\piano-pizza\Areas\PackerStaff\Views\Main\PackerProfile.cshtml"
WriteAttributeValue("", 4272, local.GetLocalizedHtmlString("CurrentPassword"), 4272, 48, false);
...
#nullable disable
            ...
            BeginWriteAttribute("placeholder", " placeholder=\"", 4684, "\"", 4742, 1);
#nullable restore
#line 75 "D:\repos\piano-pizza\piano-pizza\Areas\PackerStaff\Views\Main\PackerProfile.cshtml"
WriteAttributeValue("", 4698, local.GetLocalizedHtmlString("NewPassword"), 4698, 44, false);
...
#nullable disable
            ...
            BeginWriteAttribute("placeholder", " placeholder=\"", 5114, "\"", 5176, 1);
#nullable restore
#line 80 "D:\repos\piano-pizza\piano-pizza\Areas\PackerStaff\Views\Main\PackerProfile.cshtml"
WriteAttributeValue("", 5128, local.GetLocalizedHtmlString("ConfirmPassword"), 5128, 48, false);
...
<script>
   ...
   ");
        ...
        if (file != """") {
            ...
            $.ajax({
                type: 'POST',
                url: '/packer/Main/UpdateProfileImage',
                data: form,
                async: true,
                processData: false,
                contentType: false,
    ...
    $('#editBasicForm').submit(function (e) {
        ...
        var response = getResponseFromUrl('GET', '/packer/Main/UpdateProfile?Name=' + UserName, null, false);
        if (response.code == 200) {
    ...
    $('#editPasswordForm').submit(function (e) {
        ...
        var response = getResponseFromUrl('POST', '/packer/Main/ChangePassword', form, true);
        if (response.code == 200) {
