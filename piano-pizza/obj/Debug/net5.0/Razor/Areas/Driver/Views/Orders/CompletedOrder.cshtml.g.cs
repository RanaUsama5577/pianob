#pragma checksum "D:\repos\piano-pizza\piano-pizza\Areas\Driver\Views\Orders\CompletedOrder.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7dd26d8b27db9ea5a842833cd73b33e964f8ca49"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7dd26d8b27db9ea5a842833cd73b33e964f8ca49", @"/Areas/Driver/Views/Orders/CompletedOrder.cshtml")]
...
");
#nullable restore
#line 41 "D:\repos\piano-pizza\piano-pizza\Areas\Driver\Views\Orders\CompletedOrder.cshtml"
...
#nullable restore
#line 44 "D:\repos\piano-pizza\piano-pizza\Areas\Driver\Views\Orders\CompletedOrder.cshtml"
                                            Write(i.OrderId);
...
#nullable disable
            WriteLiteral("</td>\r\n                                            <td>");
#nullable restore
#line 49 "D:\repos\piano-pizza\piano-pizza\Areas\Driver\Views\Orders\CompletedOrder.cshtml"
                                           Write(i.PhoneNumber);
...
#nullable disable
            ...
            WriteAttributeValue("", 2322, "GetProductsDetails(", 2322, 19, true);
#nullable restore
#line 51 "D:\repos\piano-pizza\piano-pizza\Areas\Driver\Views\Orders\CompletedOrder.cshtml"
WriteAttributeValue("", 2341, i.Id, 2341, 5, false);
...
#nullable disable
            ...
            EndWriteAttribute();
            WriteLiteral(">");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "7dd26d8b27db9ea5a842833cd73b33e964f8ca497771", async() => {
            }
            );
...
<script>
    function GetProductsDetails(Id) {
        var response = getResponseFromUrl('Get', '/Driver/O");
            WriteLiteral(@"rders/GetProducts?Id=' + Id, null, false);
            ...
            if (result.length > 0) {
                ...
                result.forEach(function (doc) {
                    ...
                    data.ingredientList.forEach(function (item) {
                        ...
                        s += `<input type=""hidden"" data-product=""${data.productId}"" id");
            WriteLiteral(@"=""q-${srCount}-${data.productId}"" value=""${item.quantity}"">`;
                        srCount++;
                    })
    ...
    function GetProductsIngredients(productId, num, element) {
        ...
        for (var i = 0; i < num; i++) {
            ...
            var ");
            WriteLiteral(@"name = $('#n-' + i + ""-"" + productId).val();
