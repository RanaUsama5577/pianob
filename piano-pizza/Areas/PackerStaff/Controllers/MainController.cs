...
namespace piano_pizza.Areas.PackerStaff.Controllers
{
    [Area("PackerStaff")]
    ...
    public class MainController : Controller
    {
        ...
        public async Task<ActionResult> MarkOrderAsPacked(int Id)
        {
            var res = admin.MarkOrderAsPacked(Id, userManager1.GetUserId(HttpContext.User));
            return Json(res);
        }
