...
namespace piano_local.Areas.SuperAdmin.Controllers
{
    ...
    public class StaffController : Controller
    {
        ...
        {
            var users = admin.GetUsers(UserType.Receptionist);
            return View(users);
        }
        ...
        {
            var users = admin.GetUsers(UserType.Cook);
            return View(users);
        }
        ...
        {
            var users = admin.GetUsers(UserType.Packer);
            return View(users);
        }
        ...
        {
            var users = admin.GetUsers(UserType.Driver);
            return View(users);
        }
